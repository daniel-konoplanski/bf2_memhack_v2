...
constexpr intptr_t range = 0x44160000;
const intptr_t renddx9_plus_0x0012EEF7 = constants::modules::RENDDX9 + 0x0012EEF7;
const intptr_t renddx9_plus_0x0012EEFD = constants::modules::RENDDX9 + 0x0012EEFD;
const intptr_t range_adress = reinterpret_cast<intptr_t>(&range);
...
__attribute__((naked)) void NametagsRange::codecave()
{
    asm volatile (
        ...
        "jmp %1;"                                                 // Jump to the address stored in renddx9_plus_0x0012EEFD
        ".att_syntax;"                    
        :
